Rails.application.routes.draw do
  ...
  # path will remove '/user' text from url
  ...
  devise_for :users, controllers: { registrations: "registrations", sessions: "sessions" }, path: '', path_names: { sign_in: 'login' }
  ...
  # if a user manually types any url that isn't mentioned in routes it will show a specific page saying page not found
